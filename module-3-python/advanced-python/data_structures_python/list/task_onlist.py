...
# w.a.p to find the common elements between two lists
# w.a.p to find the difference between two lists
# w.a.p to find the union of two lists
# w.a.p to find the intersection of two lists


# applied loop based programme of list
